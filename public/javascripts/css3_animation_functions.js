...
function animate() {
    ...
    var e = document.getElementById("magical_fire");
    var s = "";
    ...
    var e = document.getElementById("magical_shadow");
    var s =
...
function toggle_css3_animations()
{
 for (var i = 0; i < fireCount; i++)
 ...
 handle = window.setInterval(function() { animate(); }, 150);
 return false;
}